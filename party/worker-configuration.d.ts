/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=party/wrangler.jsonc party/worker-configuration.d.ts` (hash: 678e7210967ccec306818f2700734127)
// Runtime types generated with workerd@1.20260911.1 2026-09-01 
interface __BaseEnv_Env {
	PARTY_SECRET: string;
	ToastRoom: DurableObjectNamespace<import("./src/index").ToastRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ToastRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PARTY_SECRET">> {}
}
